...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
   ...
   MyOnClickListener myOnClickListener;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String displayString =  laws[position];
        holder.law.setText(displayString);
        holder.law.setOnClickListener(view -> myOnClickListener.onItemClicked(position));
        String tem = newPosition + ".";
        holder.lawNum.setText(tem);
        holder.lawNum.setOnClickListener(view -> myOnClickListener.onItemClicked(position));
    }
   ...
   static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            lawNum = itemView.findViewById(R.id.numbering);
